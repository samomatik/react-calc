    ...
    render() {
        return(
            <div className="button">
                <button id="openBracket" name="(" onClick={ e => this.props.onClick(e.target.name) }>(</button>
                <button id="backSpace" name="CE" onClick={ e => this.props.onClick(e.target.name) }>CE</button>
                <button id="closeBracket" name=")" onClick={e => this.props.onClick(e.target.name) }>)</button>
                <button id="clear" name="C" onClick={e => this.props.onClick(e.target.name) }>C</button>
                <br />
                ...
                <button id="add" name="+" onClick={e => this.props.onClick(e.target.name)}>+</button>
                <br />
                ...
                <button id="subtract" name="-" onClick={e => this.props.onClick(e.target.name)}>-</button>
                <br />
